...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S TheSnap -X kill
screen -S TheSnap ./TheSnap
done
]])
Run:close()
...
Redis:incr(TheSnap.."Snap:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(TheSnap.."Snap:Lock:Contact"..msg_chat_id)
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheSnap.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '{ الغاء الامر }' then   
Redis:del(TheSnap.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه بالتوجيه للمجموعات","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(TheSnap.."Snap:ChekBotAdd")   
...
if text and Redis:get(TheSnap..'Snap:GetTexting:DevSnap'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == '{ الغاء الامر }' then 
Redis:del(TheSnap..'Snap:GetTexting:DevSnap'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ᥀︙تم الغاء حفظ كليشة المطور')
end
Redis:set(TheSnap..'Snap:Texting:DevSnap',text)
Redis:del(TheSnap..'Snap:GetTexting:DevSnap'..msg_chat_id..':'..msg.sender.user_id)
...
Redis:del(TheSnap.."Snap:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheSnap.."Snap:Set:Id:Groups",text:match("(.*)"))
...
Redis:set(TheSnap.."Snap:AddSudosNew"..msg_chat_id,true)
...
Redis:set(TheSnap.."Snap:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TheSnap.."Snap:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TheSnap.."Snap:All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(TheSnap.."Snap:All:Get:Reides:Commands:Group"..v)
Redis:del(TheSnap.."Snap:All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(TheSnap.."Snap:All:Get:Reides:Commands:Group"..v)
if Commands then 
...
data = {
{
{text = '- قناة السورس', url = 't.me/ii77i9'}, 
},
}
}
...
Redis:del(TheSnap.."Snap:ktmAll:Groups") 
...
if Redis:get(TheSnap.."Snap:Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if text == 'ترتيب الاوامر' or text == 'ترتيب' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙هاذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
